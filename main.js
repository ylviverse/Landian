...
document.querySelector('#app').innerHTML = `
  <div id="proposal-screen" class="flex items-center justify-center min-h-screen bg-gradient-to-br from-pink-100 to-pink-200">
    <div class="text-center p-8 max-w-2xl w-full px-6">
  ...
  <div id="sad-screen" class="hidden flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-100 to-blue-200">
    <div class="text-center p-8 max-w-2xl w-full px-6">
      ...
      <h1 class="text-4xl font-bold text-gray-800 mb-4 px-4">HAPPIEST BIRTHDAY Leo  ⸜(｡˃ ᵕ ˂ )⸝♡</h1>
      <p class="text-lg text-gray-700 mb-6 px-4">Wishing you lots of smiles, and Love. May your year be full of peace, growth, and little things that makes you happy. Welcome sa 20's, amping permi and don't forget to value yourself above all else :3</p>
